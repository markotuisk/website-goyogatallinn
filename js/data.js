...
const pricingData = {
    en: {
        single: {
            ...
            "options": [
                { "name": "1x Session", "price": "18€", "link": "https://wise.com/pay/r/2Dj7X2o3OoaWcFQ", "desc": "Valid for any scheduled class. Great for drop-ins. First time visiting? The Studio Explorer Pass (under Memberships) costs 29€ for 3 visits, making it only 9.66€ per class!" },
    ...
    et: {
        single: {
            ...
            "options": [
                { "name": "1x Tund", "price": "18€", "link": "https://wise.com/pay/r/2Dj7X2o3OoaWcFQ", "desc": "Kehtib ühele vabalt valitud tunnile. Oled esimest korda? Vaata Liikmepakettide alt Studio Explorer Passi – 3 tundi maksab kokku 29€, mis teeb ühe tunni hinnaks vaid 9.66€!" },
        ...
        single: {
            "title": "Kertakäynnit",
            "options": [
                { "name": "1x Tunti", "price": "18€", "link": "https://wise.com/pay/r/2Dj7X2o3OoaWcFQ", "desc": "Voimassa yhteen vapaavalintaiseen tuntiin. Ensimmäistä kertaa studiolla? Jäsenyydet-osion lT Studio Explorer Pass maksaa 29€ / 3 käyntiä, eli vain 9.66€ per tunti!" },
    ...
    ru: {
        single: {
            ...
            "options": [
                { "name": "1x Занятие", "price": "18€", "link": "https://wise.com/pay/r/2Dj7X2o3OoaWcFQ", "desc": "Действует на любой класс по расписанию. Отлично подходит для разовых визитов. Вы у нас впервые? Абонемент Studio Explorer Pass (в разделе «Абонементы») стоит 29€ за 3 посещения — всего 9.66€ за занятие!" },
